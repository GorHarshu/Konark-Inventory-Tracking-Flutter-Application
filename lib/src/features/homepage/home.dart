                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                GetCMNDesignWidget(
                                  'Finish Products',
                                  homeProvider!.countList!.finishProduct!
                                      .toString(),
                            ...
                            Row(
                              children: [
                                GetCMNDesignWidget(
                                  'Sales Orders',
                                  homeProvider!.countList!.openSalesOrder!
                                      .toString(),
                            ...
                            homeProvider!.runningAssemblyLinesList.isEmpty
                                ? Container()
                                : SingleChildScrollView(
